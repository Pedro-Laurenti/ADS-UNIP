...
% ---
\titulo{PIM VII \\ Projeto Integrado Multidiciplinar VII}
...
Carla coordena todas as áreas de conhecimento do PMBOK \citeonline{robsoncamargo}, garantindo que a equipe siga uma abordagem integrada durante todo o projeto.
...
Carla gerencia eficazmente os recursos humanos, mantém uma comunicação aberta e eficiente com a equipe e stakeholders, gerencia riscos proativamente, cuida das aquisições necessárias (por exemplo, contratação de serviços de hospedagem) e mantém um relacionamento positivo com todas as partes interessadas \citeonline{totvs}.
...
\begin{itemize}
    ...
    \item Manter uma taxa de satisfação do cliente de pelo menos 90% durante os primeiros 12 meses de operação.
\end{itemize}
